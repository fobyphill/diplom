    ...
    public partial class consumptions : System.Web.UI.Page
    {
        ...
        protected void b_search_Click(object sender, EventArgs e)
        {
            ...
            if (tb_date_create_begin.Text == "" && tb_date_create_end.Text != "")
            {
                ...
                q_find_cons += " data_create <= '" + dt.ToShortDateString() + "'";
            }
            if (tb_date_create_begin.Text != "" && tb_date_create_end.Text == "")
            {
                flag = true;
                ...
                q_find_cons += " data_create >= '" + dtb.ToShortDateString() + "'";
            }
            if (tb_date_create_begin.Text != "" && tb_date_create_end.Text != "")
            {
                flag = true;
                ...
                q_find_cons += " data_create between '" + dtb.ToShortDateString() + "' and '" + dte.ToShortDateString() + "'";
            }
