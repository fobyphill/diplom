<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rept_complex.aspx.cs" Inherits="temp_web1.rept_complex" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetData" TypeName="temp_web1.rds_complexTableAdapters.report_complexTableAdapter"></asp:ObjectDataSource>
    </form>
</body>
</html>
